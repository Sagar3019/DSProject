...
<body>
	...
	<div id="content">
		<?php
			...
			$sql="use books";
			$con->query($sql);
			$sql="select Title,Author,Quantity,Img_Path,Description from ece where Title='$title'";
			$qr=$con->query($sql);
			if($qr->num_rows > 0) 
			{
		...
		?>
		<form action="extended level 3 ece.php" method="POST">
			<center><p id="inp">Issue : </p> <input type="submit" name="title" value="<?php echo $title; ?>"></center>
		</form>
