...
<?php 
	...
	<div id="content">
		<?php
			...
			$sql="use books";
			$con->query($sql);
			$sql="select Title,Author,Quantity,Img_Path,Description from bme where Title='$title'";
			$qr=$con->query($sql);
			if($qr->num_rows > 0) 
			{
		...
		?>
		<form action="extended level 3 bme.php" method="POST">
